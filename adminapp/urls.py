...
urlpatterns = [
    ...
    path('office/create/', adminapp.office_create, name='office_create'),
    path('office/read/', adminapp.offices, name='offices'),
    path('office/update/<int:pk>/', adminapp.office_update, name='office_update'),
    path('office/delete/<int:pk>/', adminapp.office_delete, name='office_delete'),
]
